...
// import resumePdf from '../assets/RuchaAhire.pdf'; 
...
// --- NEW: Importing actual Tech Stack Brand Icons ---
// Added FaGithub and FaInfinity (DevOps loop) here
import { FaReact, FaNodeJs, FaDocker, FaDatabase, FaBrain, FaPython, FaHtml5, FaCss3Alt, FaGithub, FaInfinity } from 'react-icons/fa';
// Added SiRedis here
import { SiExpress, SiMongodb, SiFlask, SiRedis } from 'react-icons/si';
...
Engineering scalable digital infrastructure with pixel-perfect precision. I build high-performance backends and intuitive interfaces that define the future of interaction.
          ...
          <div className="hero-stats">
            <HeroStat 
              ...
              desc="Node.js, Express, Flask" 
              techIcons={<><FaNodeJs /><SiExpress /><SiFlask /></>}
            />
            <HeroStat 
              number="02" 
              title="Frontend Design" 
              desc="React, HTML5, CSS3" 
            ...
            <HeroStat 
              ...
              /* ADDED: Redis Icon */
              techIcons={<><FaDatabase /><SiMongodb /><SiRedis /></>}
            />
            <HeroStat 
              number="04" 
              title="AI / ML Integration" 
              desc="Intelligent features & Models" 
              techIcons={<><FaBrain /><FaPython /></>}
            />
            <HeroStat 
              number="05" 
              title="DevOps & Deployment" 
              desc="GitHub, Docker, CI/CD" 
              /* ADDED: GitHub and CI/CD Pipeline (Infinity) Icons */
              techIcons={<><FaGithub /><FaDocker /><FaInfinity /></>}
            />
          </div>
        </div>
      </section>
...
// Sub-components
const HeroStat = ({ number, title, desc, techIcons }) => (
  <div className="stat-card group">
    <span className="stat-number">#{number}</span>
    <h3 className="stat-title">{title}</h3>
    <p className="stat-desc">{desc}</p>
    ...
    {techIcons && (
      <div style={{ display: 'flex', gap: '0.75rem', marginTop: '0.75rem', fontSize: '1.4rem', color: '#ff4d24', opacity: 0.9 }}>
        {techIcons}
      </div>
    )}
  </div>
